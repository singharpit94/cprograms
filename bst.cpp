...
void preorder(struct node *ptr,int ,int);
...
void preorder(struct node *ptr,int indent =0,int flag =0)
{
	...
	preorder(ptr->lchild,indent+2,0);
	preorder(ptr->rchild,indent+2,1);
}/*End of preorder( )*/
